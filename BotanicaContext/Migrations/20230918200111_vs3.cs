...
namespace BotanicaContext.Migrations
{
    /// <inheritdoc />
    public partial class vs3 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 4, new DateTime(2023, 9, 18, 21, 1, 10, 950, DateTimeKind.Local).AddTicks(7847), 50, 1 },
                    { 2, 1, new DateTime(2023, 9, 18, 21, 1, 10, 950, DateTimeKind.Local).AddTicks(7911), 40, 1 },
                    { 3, 2, new DateTime(2023, 9, 18, 21, 1, 10, 950, DateTimeKind.Local).AddTicks(7913), 50, 3 },
                    { 4, 3, new DateTime(2023, 9, 18, 21, 1, 10, 950, DateTimeKind.Local).AddTicks(7916), 30, 2 }
                });
