            ...
            modelBuilder.Entity("ClassBackendBotanica.Encomenda", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ArtigoId = 4,
                            DataEncomenda = new DateTime(2023, 9, 18, 21, 1, 10, 950, DateTimeKind.Local).AddTicks(7847),
                            Quantidade = 50,
                            UtilizadorId = 1
                        },
                        new
                        {
                            Id = 2,
                            ArtigoId = 1,
                            DataEncomenda = new DateTime(2023, 9, 18, 21, 1, 10, 950, DateTimeKind.Local).AddTicks(7911),
                            Quantidade = 40,
                            UtilizadorId = 1
                        },
                        new
                        {
                            Id = 3,
                            ArtigoId = 2,
                            DataEncomenda = new DateTime(2023, 9, 18, 21, 1, 10, 950, DateTimeKind.Local).AddTicks(7913),
                            Quantidade = 50,
                            UtilizadorId = 3
                        },
                        new
                        {
                            Id = 4,
                            ArtigoId = 3,
                            DataEncomenda = new DateTime(2023, 9, 18, 21, 1, 10, 950, DateTimeKind.Local).AddTicks(7916),
                            Quantidade = 30,
                            UtilizadorId = 2
                        });
                });
