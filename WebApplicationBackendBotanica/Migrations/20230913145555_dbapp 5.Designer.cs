...
namespace WebApplicationBackendBotanica.Migrations
{
    ...
    [Migration("20230913145555_dbapp 5")]
    partial class dbapp5
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClassBackendBotanica.Encomenda", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ArtigoId = 4,
                            DataEncomenda = new DateTime(2023, 9, 13, 15, 55, 55, 474, DateTimeKind.Local).AddTicks(5344),
                            Quantidade = 50,
                            UtilizadorId = 1
                        },
                        new
                        {
                            Id = 2,
                            ArtigoId = 1,
                            DataEncomenda = new DateTime(2023, 9, 13, 15, 55, 55, 474, DateTimeKind.Local).AddTicks(5389),
                            Quantidade = 40,
                            UtilizadorId = 1
                        },
                        new
                        {
                            Id = 3,
                            ArtigoId = 2,
                            DataEncomenda = new DateTime(2023, 9, 13, 15, 55, 55, 474, DateTimeKind.Local).AddTicks(5391),
                            Quantidade = 50,
                            UtilizadorId = 3
                        },
                        new
                        {
                            Id = 4,
                            ArtigoId = 3,
                            DataEncomenda = new DateTime(2023, 9, 13, 15, 55, 55, 474, DateTimeKind.Local).AddTicks(5394),
                            Quantidade = 30,
                            UtilizadorId = 2
                        });
                });
